...
namespace PTSoft.BDSManager.WebApi.Services;
...
public class JwtAuthManager : IJwtAuthManager
{
    ...
    public JwtAuthManager(IConfiguration configuration, JwtTokenConfig jwtTokenConfig)
    {
    ...
    public JwtAuthResult GenerateTokens(string username, Claim[] claims, DateTime now)
    {
        ...
        var refreshToken = new RefreshToken
        {
            ...
            ExpireAt = DateTime.UtcNow.AddDays(_jwtTokenConfig.RefreshTokenExpiration)
        };
